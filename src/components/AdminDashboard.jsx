...
import { 
  ...
  RefreshCw, Clock, CheckCircle, X, FileText, Trash2, Award, Settings, Loader2
} from 'lucide-react';
  ...
  async function checkAdminAndFetchData() {
    ...
    try {
      ...
      await Promise.all([
        ...
        fetchAppSettings() // 💡 앱 설정 데이터 동시 로드
      ]);
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in duration-700 pb-20 font-sans relative">
      ...
      {activeTab === 'dashboard' ? (
        ...
        /* 💡 탭 2: 앱 설정 관리 화면 (이용약관 및 개인정보 처리방침) */
